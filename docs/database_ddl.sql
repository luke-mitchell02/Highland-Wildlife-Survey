...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`superuser`@`10.10.10.50`*/ /*!50003 TRIGGER `before_session_insert` BEFORE INSERT ON `Sessions` FOR EACH ROW SET NEW.session_id = CONCAT('SS_', LPAD((SELECT COUNT(*) + 1 FROM Sessions), 4, '0')) */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`superuser`@`10.10.10.50`*/ /*!50003 TRIGGER `before_sighting_insert` BEFORE INSERT ON `Sightings` FOR EACH ROW SET NEW.sighting_id = CONCAT('SI_', LPAD((SELECT COUNT(*) + 1 FROM Sightings), 4, '0')) */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
